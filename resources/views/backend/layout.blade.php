...
<head>
    ...
    <title>@yield('title', 'Panel MaxinPro')</title>
    {{-- Internal panel: must never be crawled or indexed by search engines. --}}
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 -translate-x-full min-[900px]:translate-x-0 transition-transform duration-300 z-50 w-64 bg-gradient-to-b from-brand-navy to-brand-ink text-white flex flex-col border-r border-brand-ink shadow-2xl min-[900px]:static min-[900px]:shadow-xl shrink-0">
            <div class="h-16 min-[900px]:h-[84px] flex items-center justify-between min-[900px]:justify-center px-6 border-b border-white/5 relative">
                <a href="{{ route('home') }}" class="transition-transform duration-300 hover:scale-105">
                    <img src="{{ asset('images/logo-cropped.png') }}" alt="MaxinPro" class="h-5 min-[900px]:h-6 object-contain grayscale invert contrast-200 mix-blend-screen opacity-90 hover:opacity-100">
                </a>
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 text-[13px] font-bold overflow-y-auto custom-scrollbar">
                @if ($user->isAdmin())
                    <a href="{{ route('admin.dashboard') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.users.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('admin.roles.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.roles.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                                <span class="text-[13px] font-medium">Roles (Peran)</span>
                            </div>
                        </a>
                        <a href="{{ route('admin.permissions.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.permissions.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                            <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.listings.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.listings.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                            <span class="text-[13px] font-medium">Listing</span>
                        </div>
                    </a>
                    <a href="{{ route('admin.projects.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.projects.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.leads.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.leads.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.agents.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.agents.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                            <span class="text-[13px] font-medium">Agen</span>
                        </div>
                    </a>
                    <a href="{{ route('admin.areas.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.areas.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.243-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span class="text-[13px] font-medium">Area</span>
                        </div>
                    </a>
                    <a href="{{ route('admin.developers.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.developers.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                            <span class="text-[13px] font-medium">Developer</span>
                        </div>
                    </a>
                    <a href="{{ route('admin.property-types.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.property-types.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    ...
                    <a href="{{ route('admin.articles.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.articles.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.testimonials.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.testimonials.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.partner-banks.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.partner-banks.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.audit-logs.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.audit-logs.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.settings.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.settings.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                ...
                @elseif ($user->isAgent())
                    <a href="{{ route('agent.dashboard') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('agent.dashboard') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                            <span class="text-[13px] font-medium">Dashboard</span>
                        </div>
                    </a>
                    <a href="{{ route('agent.listings.index') }}" class="block px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('agent.listings.*') ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/10' : 'text-white/60 hover:text-white hover:bg-white/5' }}">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 opacity-75" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
            ...
            <div class="px-6 py-5 border-t border-white/5 bg-black/10">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-[13px] font-bold truncate text-white">{{ $user->name }}</p>
                        <p class="text-[10px] font-medium text-white/50 uppercase tracking-wider">{{ $user->roles->first()?->name ?? 'User' }}</p>
                    </div>
                </div>
                <div class="space-y-2">
                    <a href="{{ route('account.password.edit') }}" class="block text-[12px] font-medium text-white/60 hover:text-white transition-colors">Ganti Kata Sandi</a>
                    <a href="{{ route('account.two-factor.show') }}" class="block text-[12px] font-medium text-white/60 hover:text-white transition-colors">Verifikasi Dua Langkah</a>
        ...
        <div class="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto custom-scrollbar scroll-smooth">
            ...
            <header class="min-[900px]:hidden bg-white h-16 shrink-0 flex items-center justify-between px-4 border-b border-brand-line shadow-sm sticky top-0 z-30">
                <div class="flex items-center gap-3">
                    ...
                    <img src="{{ asset('images/logo-cropped.png') }}" alt="MaxinPro" class="h-5 object-contain">
                </div>
                <div class="w-8 h-8 rounded-full bg-gradient-to-tr from-brand-blue to-purple-500 flex items-center justify-center text-white font-black text-xs shadow-md">
                    {{ substr($user->name, 0, 1) }}
                </div>
