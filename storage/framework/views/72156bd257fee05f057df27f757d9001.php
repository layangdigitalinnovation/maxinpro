...
<body class="font-sans bg-brand-soft min-h-screen flex items-center justify-center px-6">
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white border border-brand-line rounded-2xl p-7 shadow-card">
            ...
            <form action="<?php echo e(route('two-factor.challenge.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center mt-5 text-[12px] font-semibold text-brand-muted"><a href="<?php echo e(route('login')); ?>">&larr; Kembali ke login</a></p>
        <p class="text-center mt-2 text-[11.5px] font-semibold text-brand-muted">
            <a href="<?php echo e(route('two-factor.emergency-reset.create')); ?>">Kehilangan akses ke authenticator & kode pemulihan?</a>
        </p>
    </div>
</body>
</html>
<?php /**PATH D:\Layang\maxinpro.com\resources\views\auth\two-factor-challenge.blade.php ENDPATH**/ ?>