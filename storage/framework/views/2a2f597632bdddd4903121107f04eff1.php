        ...
        <div class="bg-white border border-brand-line rounded-2xl p-7 shadow-card">
            ...
            <form action="<?php echo e(route('password.update')); ?>" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email', $request->email)); ?>" required class="w-full h-[46px] border border-brand-line rounded-[9px] px-3.5 text-[13.5px]">
...
<?php /**PATH D:\Layang\maxinpro.com\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>