<?php $__env->startSection('title', 'Titip Properti — MaxinPro'); ?>
<?php $__env->startSection('meta_description', 'Titipkan properti Anda ke MaxinPro dalam 3 langkah mudah. Tanpa biaya di muka, dipasarkan ke ribuan calon pembeli aktif, didampingi agen profesional.'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <?php $__currentLoopData = [
                ...
                <div class="bg-white rounded-2xl p-6 relative overflow-hidden group border border-brand-line/50 hover:border-transparent transition-all duration-300 shadow-soft hover:shadow-soft-hover hover:-translate-y-1">
                    <div class="w-16 h-16 mx-auto mb-4 rounded-[18px] bg-gradient-to-tr <?php echo e($step['color']); ?> grid place-items-center text-3xl shadow-md text-white transform group-hover:scale-110 transition-transform duration-300"><?php echo e($step['icon']); ?></div>
                    <strong class="block text-brand-navy text-[16px] font-black mb-1.5"><?php echo e($step['title']); ?></strong>
                    <p class="text-brand-muted text-[13px] font-medium leading-relaxed"><?php echo e($step['desc']); ?></p>
                </div>
...
<section class="max-w-[1280px] mx-auto px-8 mt-12 mb-20 grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10 items-start">
    <div class="bg-white rounded-3xl p-8 lg:p-10 shadow-soft border border-brand-line/50 relative">
        ...
        <form action="<?php echo e(route('titip-properti.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="p-6 rounded-2xl bg-brand-soft/50 border border-brand-line/50 space-y-5">
                    ...
                    <div>
                        ...
                        <input required type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama sesuai identitas"
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-500 text-[12px] font-bold mt-1.5"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input required type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Contoh: 081234567890"
                                   class="w-full h-[50px] border border-brand-line rounded-xl px-4 text-[14px] transition-all hover:border-brand-blue/50 focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 outline-none">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select required name="city" class="w-full h-[50px] border border-brand-line rounded-xl px-4 text-[14px] bg-white appearance-none cursor-pointer transition-all hover:border-brand-blue/50 focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 outline-none">
                                    ...
                                    <?php $__currentLoopData = ['Tangerang Selatan', 'Tangerang', 'Jakarta Selatan', 'Jakarta Barat', 'Bekasi', 'Depok']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($city); ?>" <?php if(old('city') === $city): echo 'selected'; endif; ?>><?php echo e($city); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="p-6 rounded-2xl bg-brand-soft/50 border border-brand-line/50 space-y-5">
                    ...
                    <div>
                        ...
                        <input required type="text" name="address" value="<?php echo e(old('address')); ?>" placeholder="Nama jalan, blok, RT/RW, kelurahan"
                               class="w-full h-[50px] border border-brand-line rounded-xl px-4 text-[14px] transition-all hover:border-brand-blue/50 focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 outline-none">
                            ...
                            <div class="relative">
                                <select required name="property_type_id" class="w-full h-[50px] border border-brand-line rounded-xl px-4 text-[14px] bg-white appearance-none cursor-pointer transition-all hover:border-brand-blue/50 focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 outline-none">
                                    ...
                                    <?php $__currentLoopData = $propertyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type->id); ?>" <?php if((string) old('property_type_id') === (string) $type->id): echo 'selected'; endif; ?>><?php echo e($type->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <div class="absolute inset-y-0 right-4 flex items-center pointer-events-none">
                                    <svg class="w-4 h-4 text-brand-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input required type="text" name="expected_price" value="<?php echo e(old('expected_price')); ?>" placeholder="Contoh: 2.500.000.000"
                                   class="w-full h-[50px] border border-brand-line rounded-xl px-4 text-[14px] transition-all hover:border-brand-blue/50 focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 outline-none">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="specification" rows="4" placeholder="Contoh: 2 lantai, luas tanah 200m², luas bangunan 150m², 4 kamar tidur, hook, dekat stasiun..."
                                  class="w-full border border-brand-line rounded-xl px-4 py-3 text-[14px] transition-all hover:border-brand-blue/50 focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 outline-none resize-y"><?php echo e(old('specification')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <?php if(config('services.recaptcha.site_key')): ?>
                <div class="g-recaptcha mt-6" data-sitekey="<?php echo e(config('services.recaptcha.site_key')); ?>"></div>
    ...
    <aside class="space-y-6 sticky top-24">
            ...
            <ul class="space-y-4">
                <?php $__currentLoopData = [
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-brand-navy text-[13.5px] font-medium leading-relaxed"><?php echo e($benefit); ?></span>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
        ...
        <div class="rounded-3xl bg-gradient-to-br from-brand-navy via-brand-ink to-brand-navy text-white p-7 shadow-xl relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <a href="https://wa.me/<?php echo e(setting('whatsapp_number', '6281112345678')); ?>" target="_blank" rel="noopener" class="w-full inline-flex items-center justify-center gap-2.5 h-[48px] rounded-xl bg-white text-brand-navy hover:bg-brand-soft font-extrabold text-[14px] transition-colors shadow-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Layang\maxinpro.com\resources\views\titip-properti\create.blade.php ENDPATH**/ ?>