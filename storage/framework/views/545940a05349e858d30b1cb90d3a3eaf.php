...
<div class="max-w-[1280px] mx-auto px-8 mt-4 grid grid-cols-1 min-[900px]:grid-cols-[1.6fr_1fr] gap-8 items-start">
    ...
    <aside class="border border-brand-line rounded-2xl p-6 sticky top-[92px]">
        ...
        <?php endif; ?>
        <a href="https://wa.me/<?php echo e(setting('whatsapp_number', '6281112345678')); ?>?text=<?php echo e(urlencode('Hai, saya tertarik dengan informasi lokasi ' . $listing->title . '. Mohon informasi nya terkait unit tersebut: ' . route('listings.show', $listing))); ?>" target="_blank" rel="noopener"
