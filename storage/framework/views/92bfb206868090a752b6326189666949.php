<?php $__env->startSection('title', 'Data Developer — MaxinPro'); ?>

<?php $__env->startSection('content'); ?>
<div class="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-6">
    <h1 class="text-brand-navy text-[22px] font-black">Data Developer</h1>
    <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
        ...
        <div class="flex gap-3 w-full sm:w-auto"><a href="<?php echo e(route('admin.developers.create')); ?>" class="h-11 px-6 inline-flex items-center rounded-lg bg-brand-blue text-white text-[13px] font-extrabold hover:bg-blue-700">
        + Tambah Developer
    </a></div>
    </div>
</div>
    ...
    <div class="overflow-x-auto"><table class="w-full min-w-[800px] text-left border-collapse">
        <thead>
            <tr class="bg-gray-50 border-b border-brand-line">
                <th class="p-4 font-bold text-sm text-brand-navy">Nama Developer</th>
        ...
        <tbody class="divide-y divide-brand-line">
            <?php $__empty_1 = true; $__currentLoopData = $developers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $developer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50">
                    <td class="p-4 text-sm font-bold text-brand-navy"><?php echo e($developer->name); ?></td>
                    <td class="p-4 text-sm flex gap-3">
                        <a href="<?php echo e(route('admin.developers.edit', $developer)); ?>" class="text-blue-600 hover:underline font-bold">Edit</a>
                        <form action="<?php echo e(route('admin.developers.destroy', $developer)); ?>" method="POST" onsubmit="return confirm('Hapus developer ini?');">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
                    <td colspan="2" class="p-6 text-center text-gray-500 text-sm">Belum ada developer.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table></div>
</div>
<?php if(method_exists($developers, 'links')): ?>
<div class="mt-6"><?php echo e($developers->links()); ?></div>
<?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Layang\maxinpro.com\resources\views\admin\developers\index.blade.php ENDPATH**/ ?>