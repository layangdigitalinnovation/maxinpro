...
<form action="<?php echo e($article->exists ? route('admin.articles.update', $article) : route('admin.articles.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white border border-brand-line rounded-2xl p-6 space-y-6">
    ...
    <div class="grid grid-cols-2 gap-6">
        ...
        <div class="col-span-2">
            ...
            <textarea name="body" id="article-body" rows="12" class="w-full border border-brand-line rounded-lg px-4 py-2 focus:ring-brand-blue" required><?php echo e(old('body', $article->body)); ?></textarea>
        </div>

        <div class="col-span-2 mt-4">
            <label class="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="publish_now" value="1" <?php echo e(old('publish_now', $article->published_at) ? 'checked' : ''); ?> class="w-5 h-5 text-brand-blue border-brand-line rounded focus:ring-brand-blue">
