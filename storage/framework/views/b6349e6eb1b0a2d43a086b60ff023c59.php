...
<div class="flex flex-col lg:flex-row justify-between lg:items-center gap-4 mb-6">
    ...
    <div class="flex flex-wrap gap-2 w-full lg:w-auto items-center justify-start lg:justify-end">
        ...
        <a href="<?php echo e(route('admin.listings.trashed')); ?>" class="whitespace-nowrap h-11 px-4 inline-flex items-center rounded-lg bg-gray-200 text-brand-navy text-[13px] font-extrabold hover:bg-gray-300">
            Sampah
        </a>
        <a href="<?php echo e(route('admin.listings.create')); ?>" class="whitespace-nowrap h-11 px-4 sm:px-5 inline-flex items-center rounded-lg bg-brand-blue text-white text-[13px] font-extrabold hover:bg-blue-700">
            + Tambah Listing
        </a>
    </div>
</div>
