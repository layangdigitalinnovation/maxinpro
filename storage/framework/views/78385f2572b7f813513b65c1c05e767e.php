...
<body class="font-sans bg-brand-soft min-h-screen flex items-center justify-center px-6">
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white border border-brand-line rounded-2xl p-7 shadow-card text-center">
            ...
            <form action="<?php echo e(route('verification.send')); ?>" method="POST" class="mb-3">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Layang\maxinpro.com\resources\views\auth\verify-email.blade.php ENDPATH**/ ?>