    ...
    <div class="w-full max-w-sm">
        <div class="text-center mb-6">
            <a href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('images/logo-cropped.png')); ?>" alt="MaxinPro" class="h-10 mx-auto">
            </a>
        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-5">
                    <div class="flex items-center justify-between mb-1.5">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-[11.5px] font-bold">Lupa kata sandi?</a>
                    </div>
        ...
        <p class="text-center mt-5 text-[12px] font-semibold text-brand-muted">
            <a href="<?php echo e(route('home')); ?>">&larr; Kembali ke website</a>
        </p>
    </div>
</body>
</html>
<?php /**PATH D:\Layang\maxinpro.com\resources\views/auth/login.blade.php ENDPATH**/ ?>