...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?php echo e(route('agent.listings.index')); ?>" class="h-11 px-6 inline-flex items-center rounded-lg bg-gray-200 text-brand-navy text-[13px] font-extrabold hover:bg-gray-300">
        Kembali
    </a>
</div>
...
<form action="<?php echo e($listing->exists ? route('agent.listings.update', $listing) : route('agent.listings.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Layang\maxinpro.com\resources\views\agent\listings\form.blade.php ENDPATH**/ ?>